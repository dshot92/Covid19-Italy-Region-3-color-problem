...
The idea comes from the subdivision of the regions, by the Italian Government, for the application of different regulations regarding the containment of SARS-CoV-2 virus (Covid-19).

The code explores the possibility of the regions to be colored with just 3 possible different colors so that no two regions with a common boundary have the same color.
...
Italy regions are **not** 3-colorable!

In alphabetical order, <u>Molise</u> and <u>Toscana</u> have no possible color assigned.

In Reverse alphabetical order, <u>Emilia Romagna</u> and <u>Lazio</u> have no possible color assigned.
